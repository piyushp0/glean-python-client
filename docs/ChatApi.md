...
# **ask**
> AskResponse ask(x_scio_actas=x_scio_actas, payload=payload)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Detect and answer questions
        api_response = api_instance.ask(x_scio_actas=x_scio_actas, payload=payload)
...
# **chat**
> ChatResponse chat(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ChatApi(api_client)
    payload = {"messages":[{"author":"USER","fragments":[{"text":"What are the company holidays this year?"}]}]} # ChatRequest | Includes chat history for Glean AI to respond to.
    x_scio_actas = 'x_scio_actas_example' # str | Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens). (optional)
    ...
    try:
        # Chat
        api_response = api_instance.chat(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
# **deleteallchats**
> deleteallchats(x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes all saved Chats owned by a user
        api_instance.deleteallchats(x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
    except Exception as e:
...
# **deletechats**
> deletechats(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes saved Chats
        api_instance.deletechats(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
    except Exception as e:
...
# **getchat**
> GetChatResponse getchat(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a Chat
        api_response = api_instance.getchat(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
# **getchatapplication**
> GetChatApplicationResponse getchatapplication(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the metadata for a custom Chat application
        api_response = api_instance.getchatapplication(payload, x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
# **listchats**
> ListChatsResponse listchats(x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves all saved Chats
        api_response = api_instance.listchats(x_scio_actas=x_scio_actas, timezone_offset=timezone_offset)
