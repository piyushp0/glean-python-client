...
class AuthenticationApi:
    ...
    def createanonymoustoken(
        ...
        _param = self._createanonymoustoken_serialize(
    ...
    @validate_call
    def createanonymoustoken_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def createanonymoustoken_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _createanonymoustoken_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/createanonymoustoken',
    ...
    def createauthtoken(
        ...
        _param = self._createauthtoken_serialize(
    ...
    @validate_call
    def createauthtoken_with_http_info(
        self,
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def createauthtoken_without_preload_content(
        self,
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
            None,
    ...
    def _createauthtoken_serialize(
        self,
        x_scio_actas,
        _request_auth,
        _content_type,
