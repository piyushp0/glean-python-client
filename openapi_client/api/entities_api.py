...
class EntitiesApi:
    ...
    def createteams(
        self,
        payload: Annotated[CreateTeamsRequest, Field(description="Teams to be created")],
        ...
        :param payload: Teams to be created (required)
        :type payload: CreateTeamsRequest
        ...
        _param = self._createteams_serialize(
            payload=payload,
    ...
    @validate_call
    def createteams_with_http_info(
        self,
        payload: Annotated[CreateTeamsRequest, Field(description="Teams to be created")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateTeamsResponse]:
        """Create teams
    ...
    @validate_call
    def createteams_without_preload_content(
        self,
        payload: Annotated[CreateTeamsRequest, Field(description="Teams to be created")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
    ...
    def customentities(
        self,
        payload: Annotated[CustomEntitiesRequest, Field(description="Custom entities request")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param payload: Custom entities request (required)
        :type payload: CustomEntitiesRequest
        :param x_scio_actas: Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
        :type x_scio_actas: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._customentities_serialize(
            payload=payload,
            x_scio_actas=x_scio_actas,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def customentities_with_http_info(
        self,
        payload: Annotated[CustomEntitiesRequest, Field(description="Custom entities request")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomEntitiesResponse]:
        """Read custom entities
    ...
    @validate_call
    def customentities_without_preload_content(
        self,
        payload: Annotated[CustomEntitiesRequest, Field(description="Custom entities request")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
    ...
    def deleteteams(
        self,
        payload: Annotated[DeleteTeamsRequest, Field(description="Teams to be deleted")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param payload: Teams to be deleted (required)
        :type payload: DeleteTeamsRequest
        :param x_scio_actas: Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
        :type x_scio_actas: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._deleteteams_serialize(
            payload=payload,
            x_scio_actas=x_scio_actas,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def deleteteams_with_http_info(
        self,
        payload: Annotated[DeleteTeamsRequest, Field(description="Teams to be deleted")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteTeamsResponse]:
        """Delete teams
    ...
    @validate_call
    def deleteteams_without_preload_content(
        self,
        payload: Annotated[DeleteTeamsRequest, Field(description="Teams to be deleted")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
    ...
    def downloadentities(
        self,
        entity_type: Annotated[EntitiesTypeEnum, Field(description="Entity type the requested CSV should be populated with")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param entity_type: Entity type the requested CSV should be populated with (required)
        :type entity_type: EntitiesTypeEnum
        :param x_scio_actas: Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
        :type x_scio_actas: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._downloadentities_serialize(
    ...
    @validate_call
    def downloadentities_with_http_info(
        self,
        entity_type: Annotated[EntitiesTypeEnum, Field(description="Entity type the requested CSV should be populated with")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def downloadentities_without_preload_content(
        self,
        entity_type: Annotated[EntitiesTypeEnum, Field(description="Entity type the requested CSV should be populated with")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
    ...
    def _downloadentities_serialize(
        self,
        entity_type,
        x_scio_actas,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/downloadentities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def teams(
        self,
        payload: Annotated[TeamsRequest, Field(description="Teams request")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param payload: Teams request (required)
        :type payload: TeamsRequest
        :param x_scio_actas: Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
        :type x_scio_actas: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
