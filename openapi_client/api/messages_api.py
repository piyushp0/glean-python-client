...
class MessagesApi:
    ...
    def messages(
        self,
        payload: Annotated[MessagesRequest, Field(description="Includes request params such as the id for channel/message and direction.")],
        ...
        :param payload: Includes request params such as the id for channel/message and direction. (required)
        :type payload: MessagesRequest
        ...
        _param = self._messages_serialize(
            payload=payload,
    ...
    @validate_call
    def messages_without_preload_content(
        self,
        payload: Annotated[MessagesRequest, Field(description="Includes request params such as the id for channel/message and direction.")],
        x_scio_actas: Annotated[Optional[StrictStr], Field(description="Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).")] = None,
        _request_timeout: Union[
