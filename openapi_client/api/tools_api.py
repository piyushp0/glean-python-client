...
class ToolsApi:
    ...
    @validate_call
    def executeactiontool(
        self,
        payload: Annotated[ExecuteActionToolRequest, Field(description="Execute Action Tool request")],
        ...
        :param payload: Execute Action Tool request (required)
        :type payload: ExecuteActionToolRequest
        ...
        _param = self._executeactiontool_serialize(
            payload=payload,
    ...
    @validate_call
    def executeactiontool_with_http_info(
        self,
        payload: Annotated[ExecuteActionToolRequest, Field(description="Execute Action Tool request")],
        timezone_offset: Annotated[Optional[StrictInt], Field(description="The offset of the client's timezone in minutes from UTC. e.g. PDT is -420 because it's 7 hours behind UTC.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExecuteActionToolResponse]:
        """Execute Action Tool
    ...
    @validate_call
    def executeactiontool_without_preload_content(
        self,
        payload: Annotated[ExecuteActionToolRequest, Field(description="Execute Action Tool request")],
        timezone_offset: Annotated[Optional[StrictInt], Field(description="The offset of the client's timezone in minutes from UTC. e.g. PDT is -420 because it's 7 hours behind UTC.")] = None,
        _request_timeout: Union[
    ...
    def _executeactiontool_serialize(
        self,
        payload,
        timezone_offset,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/executeactiontool',
