...
class AdminAlertEmailTemplateProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bannerType", "bannerText", "alertDescription", "relevanceDescription", "resolutionStepsDescription", "resolutionSteps", "helpLink"]
