...
class AgentClientConfig(BaseModel):
    ...
    input_char_limit: Optional[StrictInt] = Field(default=None, description="The character limit of an input to GleanChat under the specified AgentConfig.", alias="inputCharLimit")
    __properties: ClassVar[List[str]] = ["agentConfig", "inputCharLimit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputCharLimit": obj.get("inputCharLimit")
        })
        return _obj
