...
class AgentConfig(BaseModel):
    ...
    def agent_validate_enum(cls, value):
        ...
        if value not in set(['DEFAULT', 'GPT']):
            raise ValueError("must be one of enum values ('DEFAULT', 'GPT')")
        return value
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['DEFAULT', 'QUICK']):
            raise ValueError("must be one of enum values ('DEFAULT', 'QUICK')")
        return value
