...
class Announcement(BaseModel):
    ...
    draft_id: Optional[StrictInt] = Field(default=None, description="The opaque id of the associated draft.", alias="draftId")
    ...
    create_timestamp: Optional[StrictInt] = Field(default=None, description="Server Unix timestamp of the creation time (in seconds since epoch UTC).", alias="createTimestamp")
    last_update_timestamp: Optional[StrictInt] = Field(default=None, description="Server Unix timestamp of the last update time (in seconds since epoch UTC).", alias="lastUpdateTimestamp")
    updated_by: Optional[Person] = Field(default=None, alias="updatedBy")
    viewer_info: Optional[AnnouncementAllOfViewerInfo] = Field(default=None, alias="viewerInfo")
    source_document: Optional[Document] = Field(default=None, alias="sourceDocument")
    is_published: Optional[StrictBool] = Field(default=None, description="Whether or not the announcement is published.", alias="isPublished")
    __properties: ClassVar[List[str]] = ["startTime", "endTime", "title", "body", "emoji", "thumbnail", "banner", "audienceFilters", "sourceDocumentId", "hideAttribution", "channel", "postType", "isPrioritized", "viewUrl", "draftId", "permissions", "id", "author", "createTimestamp", "lastUpdateTimestamp", "updatedBy", "viewerInfo", "sourceDocument", "isPublished"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "viewerInfo": AnnouncementAllOfViewerInfo.from_dict(obj["viewerInfo"]) if obj.get("viewerInfo") is not None else None,
