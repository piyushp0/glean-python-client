...
class AnswerBoardResult(BaseModel):
    ...
    """ # noqa: E501
    board: AnswerBoard
    tracking_token: Optional[StrictStr] = Field(default=None, description="An opaque token that represents this particular Answer Board. To be used for /feedback reporting.", alias="trackingToken")
    __properties: ClassVar[List[str]] = ["board", "trackingToken"]
