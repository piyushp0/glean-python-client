...
class AnswerCreationData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["question", "questionVariations", "bodyText", "boardId", "audienceFilters", "addedRoles", "removedRoles", "roles", "sourceDocumentSpec", "sourceType", "addedCollections", "combinedAnswerText"]
