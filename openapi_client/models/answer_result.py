...
class AnswerResult(BaseModel):
    ...
    """ # noqa: E501
    answer: Answer
    tracking_token: Optional[StrictStr] = Field(default=None, description="An opaque token that represents this particular Answer. To be used for `/feedback` reporting.", alias="trackingToken")
    __properties: ClassVar[List[str]] = ["answer", "trackingToken"]
