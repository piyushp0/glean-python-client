...
class Branding(BaseModel):
    ...
    """ # noqa: E501
    company_background_image_name: Optional[StrictStr] = Field(default=None, description="User facing company background image to be displayed to users on the home page.", alias="companyBackgroundImageName")
