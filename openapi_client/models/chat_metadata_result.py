...
class ChatMetadataResult(BaseModel):
    ...
    tracking_token: Optional[StrictStr] = Field(default=None, description="An opaque token that represents this particular Chat. To be used for `/feedback` reporting.", alias="trackingToken")
    __properties: ClassVar[List[str]] = ["chat", "trackingToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chat": ChatMetadata.from_dict(obj["chat"]) if obj.get("chat") is not None else None,
