...
class CodeLine(BaseModel):
    ...
    ranges: Optional[List[TextRange]] = Field(default=None, description="Index ranges depicting matched sections of the line")
    __properties: ClassVar[List[str]] = ["lineNumber", "content", "ranges"]
...
CodeLine.model_rebuild(raise_errors=False)
