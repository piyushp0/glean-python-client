...
class Collection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "addedRoles", "removedRoles", "audienceFilters", "icon", "adminLocked", "parentId", "thumbnail", "allowedDatasource", "permissions", "id", "createTime", "updateTime", "creator", "updatedBy", "itemCount", "childCount", "items", "pinMetadata", "shortcuts", "children", "roles"]
...
Collection.model_rebuild(raise_errors=False)
