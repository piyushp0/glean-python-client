...
class CreateCollectionRequest(BaseModel):
    ...
    new_next_item_id: Optional[StrictStr] = Field(default=None, description="The (optional) ItemId of the next CollectionItem in sequence. If omitted, will be added to the end of the Collection. Only used if parentId is specified.", alias="newNextItemId")
    __properties: ClassVar[List[str]] = ["name", "description", "addedRoles", "removedRoles", "audienceFilters", "icon", "adminLocked", "parentId", "thumbnail", "allowedDatasource", "newNextItemId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newNextItemId": obj.get("newNextItemId")
        })
        return _obj
