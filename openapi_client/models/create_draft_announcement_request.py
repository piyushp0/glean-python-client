...
class CreateDraftAnnouncementRequest(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="The opaque id of the parent announcement.")
    __properties: ClassVar[List[str]] = ["startTime", "endTime", "title", "body", "emoji", "thumbnail", "banner", "audienceFilters", "sourceDocumentId", "hideAttribution", "channel", "postType", "isPrioritized", "viewUrl", "id"]
