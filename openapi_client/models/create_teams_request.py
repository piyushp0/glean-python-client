...
class CreateTeamsRequest(BaseModel):
    ...
    CreateTeamsRequest
    """ # noqa: E501
    teams: Optional[List[TeamCreationData]] = Field(default=None, description="List of all teams from data sources to create")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [TeamCreationData.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
