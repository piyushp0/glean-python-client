...
class CustomerMetadata(BaseModel):
    ...
    CustomerMetadata
    """ # noqa: E501
    datasource_id: Optional[StrictStr] = Field(default=None, description="The user visible id of the salesforce customer account.", alias="datasourceId")
    ...
    __properties: ClassVar[List[str]] = ["datasourceId", "customData"]
