...
class Disambiguation(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the ambiguous entity")
    id: Optional[StrictStr] = Field(default=None, description="The unique id of the entity in the knowledge graph")
    type: Optional[EntityType] = None
    __properties: ClassVar[List[str]] = ["name", "id", "type"]
