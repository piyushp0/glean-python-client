...
class DisplayableListConfig(BaseModel):
    ...
    """ # noqa: E501
    format: Optional[StrictStr] = Field(default=None, description="defines how to render this particular displayable list card")
    title: Optional[StrictStr] = Field(default=None, description="Primary title for the list.")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the list should be shown to the user")
    audience_filters: Optional[List[FacetFilter]] = Field(default=None, description="Filters which restrict who should should see displayable list", alias="audienceFilters")
    item_ui_config: Optional[DisplayableListItemUIConfig] = Field(default=None, alias="itemUIConfig")
    __properties: ClassVar[List[str]] = ["format", "title", "enabled", "audienceFilters", "itemUIConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.item_ui_config:
            _dict['itemUIConfig'] = self.item_ui_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemUIConfig": DisplayableListItemUIConfig.from_dict(obj["itemUIConfig"]) if obj.get("itemUIConfig") is not None else None
        })
        return _obj
