...
class DocumentInsight(BaseModel):
    ...
    """ # noqa: E501
    document: Document
    view_count: Optional[CountInfo] = Field(default=None, alias="viewCount")
    visitor_count: Optional[CountInfo] = Field(default=None, alias="visitorCount")
    __properties: ClassVar[List[str]] = ["document", "viewCount", "visitorCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "viewCount": CountInfo.from_dict(obj["viewCount"]) if obj.get("viewCount") is not None else None,
