...
class EditAnswerBoardRequest(BaseModel):
    ...
    id: StrictInt = Field(description="The ID of the Answer Board to modify.")
    __properties: ClassVar[List[str]] = ["name", "description", "addedRoles", "removedRoles", "audienceFilters", "id"]
