...
class EditAnswerRequest(BaseModel):
    ...
    added_collections: Optional[List[StrictInt]] = Field(default=None, description="IDs of Collections to which a document is added.", alias="addedCollections")
    removed_collections: Optional[List[StrictInt]] = Field(default=None, description="IDs of Collections from which a document is removed.", alias="removedCollections")
    combined_answer_text: Optional[StructuredTextMutableProperties] = Field(default=None, alias="combinedAnswerText")
    __properties: ClassVar[List[str]] = ["id", "docId", "question", "questionVariations", "bodyText", "boardId", "audienceFilters", "addedRoles", "removedRoles", "roles", "sourceDocumentSpec", "sourceType", "addedCollections", "removedCollections", "combinedAnswerText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addedCollections": obj.get("addedCollections"),
            "removedCollections": obj.get("removedCollections"),
            "combinedAnswerText": StructuredTextMutableProperties.from_dict(obj["combinedAnswerText"]) if obj.get("combinedAnswerText") is not None else None
        })
        return _obj
