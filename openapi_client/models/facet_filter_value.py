...
class FacetFilterValue(BaseModel):
    ...
    is_negated: Optional[StrictBool] = Field(default=None, description="DEPRECATED - please use relationType instead", alias="isNegated")
    __properties: ClassVar[List[str]] = ["value", "relationType", "isNegated"]
