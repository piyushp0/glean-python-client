...
class Feedback(BaseModel):
    ...
    def category_validate_enum(cls, value):
        ...
        if value not in set(['ANNOUNCEMENT', 'AUTOCOMPLETE', 'COLLECTIONS', 'FEED', 'SEARCH', 'CHAT', 'NTP', 'WORKFLOWS', 'SUMMARY', 'GENERAL', 'PROMPTS']):
            raise ValueError("must be one of enum values ('ANNOUNCEMENT', 'AUTOCOMPLETE', 'COLLECTIONS', 'FEED', 'SEARCH', 'CHAT', 'NTP', 'WORKFLOWS', 'SUMMARY', 'GENERAL', 'PROMPTS')")
        return value
