...
class FollowupAction(BaseModel):
    ...
    """ # noqa: E501
    action_instance_id: Optional[StrictStr] = Field(default=None, description="The ID of the action instance that will be invoked.", alias="actionInstanceId")
    __properties: ClassVar[List[str]] = ["actionInstanceId"]
