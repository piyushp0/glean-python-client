...
class GetAnnouncementResponse(BaseModel):
    ...
    tracking_token: Optional[StrictStr] = Field(default=None, description="An opaque token that represents this particular announcement. To be used for /feedback reporting.", alias="trackingToken")
    error: Optional[AnnouncementError] = None
    __properties: ClassVar[List[str]] = ["announcement", "trackingToken", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": AnnouncementError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
