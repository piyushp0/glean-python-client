...
class GetCollectionResponse(BaseModel):
    ...
    root_collection: Optional[Collection] = Field(default=None, alias="rootCollection")
    tracking_token: Optional[StrictStr] = Field(default=None, description="An opaque token that represents this particular Collection. To be used for `/feedback` reporting.", alias="trackingToken")
    error: Optional[CollectionError] = None
    __properties: ClassVar[List[str]] = ["collection", "rootCollection", "trackingToken", "error"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of root_collection
        if self.root_collection:
            _dict['rootCollection'] = self.root_collection.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rootCollection": Collection.from_dict(obj["rootCollection"]) if obj.get("rootCollection") is not None else None,
