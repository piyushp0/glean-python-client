...
class GetDocumentsRequest(BaseModel):
    ...
    GetDocumentsRequest
    """ # noqa: E501
    document_specs: List[DocumentSpec] = Field(description="The specification for the documents to be retrieved.", alias="documentSpecs")
    include_fields: Optional[List[StrictStr]] = Field(default=None, description="List of Document fields to return (that aren't returned by default)", alias="includeFields")
    __properties: ClassVar[List[str]] = ["documentSpecs", "includeFields"]
    ...
    def include_fields_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['LAST_VIEWED_AT', 'VISITORS_COUNT', 'RECENT_SHARES', 'DOCUMENT_CONTENT']):
                raise ValueError("each list item must be one of ('LAST_VIEWED_AT', 'VISITORS_COUNT', 'RECENT_SHARES', 'DOCUMENT_CONTENT')")
        return value
