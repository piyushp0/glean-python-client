...
class GetDocumentsResponse(BaseModel):
    ...
    """ # noqa: E501
    documents: Optional[Dict[str, DocumentOrError]] = Field(default=None, description="The document details or the error if document is not found.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": dict(
                (_k, DocumentOrError.from_dict(_v))
