...
class GetEventsRequest(BaseModel):
    ...
    GetEventsRequest
    """ # noqa: E501
    ids: List[StrictStr] = Field(description="The ids of the calendar events to be retrieved.")
    auth_tokens: Optional[List[AuthToken]] = Field(default=None, description="Auth tokens if client-side authentication.", alias="authTokens")
    ...
    annotate: Optional[StrictBool] = Field(default=None, description="Whether relevant content and documents, via GeneratedAttachments, should be attached to the events.")
    __properties: ClassVar[List[str]] = ["ids", "authTokens", "datasource", "annotate"]
