...
class GetSimilarShortcutsResponse(BaseModel):
    ...
    """ # noqa: E501
    shortcuts: List[Shortcut] = Field(description="Shortcuts with similar aliases to the given. Includes shortcut with the exact alias if it exists.")
    __properties: ClassVar[List[str]] = ["shortcuts"]
