...
class LabeledCountInfo(BaseModel):
    ...
    LabeledCountInfo
    """ # noqa: E501
    label: StrictStr = Field(description="Label for the included count information.")
    count_info: Optional[List[CountInfo]] = Field(default=None, description="List of data points for counts for a given date period.", alias="countInfo")
    __properties: ClassVar[List[str]] = ["label", "countInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "countInfo": [CountInfo.from_dict(_item) for _item in obj["countInfo"]] if obj.get("countInfo") is not None else None
        })
        return _obj
