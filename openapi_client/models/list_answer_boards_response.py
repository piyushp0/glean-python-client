...
class ListAnswerBoardsResponse(BaseModel):
    ...
    """ # noqa: E501
    board_results: List[AnswerBoardResult] = Field(description="List of all Answer Boards, no Answers are included.", alias="boardResults")
    __properties: ClassVar[List[str]] = ["boardResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boardResults": [AnswerBoardResult.from_dict(_item) for _item in obj["boardResults"]] if obj.get("boardResults") is not None else None
        })
        return _obj
