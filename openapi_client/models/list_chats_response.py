...
class ListChatsResponse(BaseModel):
    ...
    ListChatsResponse
    """ # noqa: E501
    chat_results: Optional[List[ChatMetadataResult]] = Field(default=None, alias="chatResults")
    __properties: ClassVar[List[str]] = ["chatResults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chatResults": [ChatMetadataResult.from_dict(_item) for _item in obj["chatResults"]] if obj.get("chatResults") is not None else None
        })
        return _obj
