...
class ListShortcutsPaginatedResponse(BaseModel):
    ...
    """ # noqa: E501
    shortcuts: List[Shortcut] = Field(description="List of all shortcuts accessible to the user")
    facet_results: Optional[List[FacetResult]] = Field(default=None, alias="facetResults")
    meta: ShortcutsPaginationMetadata
    __properties: ClassVar[List[str]] = ["shortcuts", "facetResults", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ShortcutsPaginationMetadata.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
