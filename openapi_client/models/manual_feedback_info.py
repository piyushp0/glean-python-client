...
class ManualFeedbackInfo(BaseModel):
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['AUTOCOMPLETE', 'CALENDAR', 'CHAT', 'CHAT_GENERAL', 'CONCEPT_CARD', 'DESKTOP_APP', 'DISAMBIGUATION_CARD', 'EXPERT_DETECTION', 'FEED', 'GENERATED_Q_AND_A', 'NATIVE_RESULT', 'Q_AND_A', 'RELATED_QUESTIONS', 'REPORT_ISSUE', 'SCIOBOT', 'SEARCH', 'SUMMARY']):
            raise ValueError("must be one of enum values ('AUTOCOMPLETE', 'CALENDAR', 'CHAT', 'CHAT_GENERAL', 'CONCEPT_CARD', 'DESKTOP_APP', 'DISAMBIGUATION_CARD', 'EXPERT_DETECTION', 'FEED', 'GENERATED_Q_AND_A', 'NATIVE_RESULT', 'Q_AND_A', 'RELATED_QUESTIONS', 'REPORT_ISSUE', 'SCIOBOT', 'SEARCH', 'SUMMARY')")
        return value
