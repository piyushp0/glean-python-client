...
class PeopleFilters(BaseModel):
    ...
    PeopleFilters
    """ # noqa: E501
    filter: Optional[List[FacetFilter]] = Field(default=None, description="Facets used for filtering people search")
    query: Optional[StrictStr] = Field(default=None, description="A query string to search for people that each person in the response must conform to. An empty query does not filter any people.")
    __properties: ClassVar[List[str]] = ["filter", "query"]
