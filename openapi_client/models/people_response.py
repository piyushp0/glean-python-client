...
class PeopleResponse(BaseModel):
    ...
    PeopleResponse
    """ # noqa: E501
    results: Optional[List[Person]] = Field(default=None, description="A Person for each ID in the request, each with PersonMetadata populated.")
    related_documents: Optional[List[RelatedDocuments]] = Field(default=None, description="A list of documents related to this people response. This is only included if DOCUMENT_ACTIVITY is requested and only 1 person is included in the request.", alias="relatedDocuments")
    errors: Optional[List[StrictStr]] = Field(default=None, description="A list of IDs that could not be found.")
    __properties: ClassVar[List[str]] = ["results", "relatedDocuments", "errors"]
