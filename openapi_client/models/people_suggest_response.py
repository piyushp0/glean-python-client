...
class PeopleSuggestResponse(BaseModel):
    ...
    """ # noqa: E501
    suggestions: Optional[List[PersonSuggestionList]] = Field(default=None, description="Information about people suggestions for asked categories.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suggestions": [PersonSuggestionList.from_dict(_item) for _item in obj["suggestions"]] if obj.get("suggestions") is not None else None
        })
        return _obj
