...
class PinDocument(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The opaque id of the pin.")
    document_id: StrictStr = Field(description="The document which should be a pinned result.", alias="documentId")
    ...
    __properties: ClassVar[List[str]] = ["queries", "audienceFilters", "id", "documentId", "attribution", "updatedBy", "createTime", "updateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribution": Person.from_dict(obj["attribution"]) if obj.get("attribution") is not None else None,
...
PinDocument.model_rebuild(raise_errors=False)
