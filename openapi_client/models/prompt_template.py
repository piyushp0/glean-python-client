...
class PromptTemplate(BaseModel):
    ...
    PromptTemplate
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The user-given identifier for this prompt template.")
    template: StrictStr = Field(description="The actual template string.")
    application_id: Optional[StrictStr] = Field(default=None, description="The Application Id the prompt template should be created under. Empty for default assistant.", alias="applicationId")
    ...
    id: Optional[StrictStr] = Field(default=None, description="Opaque id for this prompt template")
    ...
    __properties: ClassVar[List[str]] = ["name", "template", "applicationId", "inclusions", "addedRoles", "removedRoles", "permissions", "id", "author", "createTimestamp", "lastUpdateTimestamp", "lastUpdatedBy", "roles"]
