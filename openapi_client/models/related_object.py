...
class RelatedObject(BaseModel):
    ...
    RelatedObject
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the related object")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metadata": RelatedObjectMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
