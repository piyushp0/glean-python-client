...
class TeamsResponse(BaseModel):
    ...
    TeamsResponse
    """ # noqa: E501
    results: Optional[List[Team]] = Field(default=None, description="A Team and a deep copy of all its members for each ID in the request")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Team.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
