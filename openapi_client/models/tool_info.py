...
class ToolInfo(BaseModel):
    ...
    parameters: Optional[Dict[str, WriteActionParameter]] = Field(default=None, description="Parameters supported by the tool.")
    __properties: ClassVar[List[str]] = ["metadata", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": ToolMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "parameters": dict(
