...
class ToolsConfig(BaseModel):
    ...
    """ # noqa: E501
    available_tools: Optional[List[ToolMetadata]] = Field(default=None, description="List of tools available to the user.", alias="availableTools")
    __properties: ClassVar[List[str]] = ["availableTools"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableTools": [ToolMetadata.from_dict(_item) for _item in obj["availableTools"]] if obj.get("availableTools") is not None else None
        })
        return _obj
