...
class UgcDraft(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["announcement", "answer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "announcement": AnnouncementMutableProperties.from_dict(obj["announcement"]) if obj.get("announcement") is not None else None,
            "answer": AnswerMutableProperties.from_dict(obj["answer"]) if obj.get("answer") is not None else None
        })
        return _obj
