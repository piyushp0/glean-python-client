...
class UpdateShortcutRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="The opaque id of the user generated content.")
    input_alias: Optional[StrictStr] = Field(default=None, description="Link text following go/ prefix as entered by the user.", alias="inputAlias")
    ...
    __properties: ClassVar[List[str]] = ["id", "inputAlias", "destinationUrl", "destinationDocumentId", "description", "unlisted", "urlTemplate", "addedRoles", "removedRoles"]
