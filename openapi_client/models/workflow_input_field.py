...
class WorkflowInputField(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the input.")
    display_name: Optional[StrictStr] = Field(default=None, description="Name of the field as displayed to the user.", alias="displayName")
