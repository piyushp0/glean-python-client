...
class WorkflowSchema(BaseModel):
    ...
    """ # noqa: E501
    goal: Optional[StrictStr] = Field(default=None, description="The goal of the workflow. This is passed into each step.")
    steps: List[WorkflowStep]
    fields: Optional[List[WorkflowInputField]] = Field(default=None, description="Fields can be used in the goal, step instruction templates, and tool config input templates.")
    __properties: ClassVar[List[str]] = ["goal", "steps", "fields"]
