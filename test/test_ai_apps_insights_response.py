...
class TestAiAppsInsightsResponse(unittest.TestCase):
    """AiAppsInsightsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AiAppsInsightsResponse:
        """Test AiAppsInsightsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AiAppsInsightsResponse`
        """
        model = AiAppsInsightsResponse()
        if include_optional:
            return AiAppsInsightsResponse(
    ...
    def testAiAppsInsightsResponse(self):
        """Test AiAppsInsightsResponse"""
