...
class TestAnswerBoard(unittest.TestCase):
    """AnswerBoard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnswerBoard:
        """Test AnswerBoard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnswerBoard`
        """
        model = AnswerBoard()
        if include_optional:
            return AnswerBoard(
