...
class TestAnswerCreationData(unittest.TestCase):
    """AnswerCreationData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnswerCreationData:
        """Test AnswerCreationData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnswerCreationData`
        """
        model = AnswerCreationData()
        if include_optional:
    ...
    def testAnswerCreationData(self):
        """Test AnswerCreationData"""
