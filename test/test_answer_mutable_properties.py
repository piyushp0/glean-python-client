...
class TestAnswerMutableProperties(unittest.TestCase):
    """AnswerMutableProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnswerMutableProperties:
        """Test AnswerMutableProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnswerMutableProperties`
        """
        model = AnswerMutableProperties()
        if include_optional:
            return AnswerMutableProperties(
    ...
    def testAnswerMutableProperties(self):
        """Test AnswerMutableProperties"""
