        ...
        if include_optional:
            return AutocompleteResponse(
                ...
                session_info = openapi_client.models.session_info.SessionInfo(
                    ...
                    last_query = '', ),
                results = [
                    {"result":"sample result","resultType":"DOCUMENT","score":4.56,"url":"https://www.example.com/","trackingToken":"abcd","metadata":[{"datasource":"confluence"},{"objectType":"page"}]}
                    ],
                groups = [
                    openapi_client.models.autocomplete_result_group.AutocompleteResultGroup(
                        start_index = 56, 
                        end_index = 56, 
                        title = '', )
                    ],
