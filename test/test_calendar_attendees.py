...
class TestCalendarAttendees(unittest.TestCase):
    """CalendarAttendees unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarAttendees:
        """Test CalendarAttendees
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarAttendees`
        """
    ...
    def testCalendarAttendees(self):
        """Test CalendarAttendees"""
