...
class TestChannelInviteInfo(unittest.TestCase):
    """ChannelInviteInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelInviteInfo:
        """Test ChannelInviteInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelInviteInfo`
        """
        model = ChannelInviteInfo()
        if include_optional:
    ...
    def testChannelInviteInfo(self):
        """Test ChannelInviteInfo"""
