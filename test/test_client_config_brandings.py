...
class TestClientConfigBrandings(unittest.TestCase):
    """ClientConfigBrandings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientConfigBrandings:
        """Test ClientConfigBrandings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientConfigBrandings`
        """
        model = ClientConfigBrandings()
        if include_optional:
            return ClientConfigBrandings(
                light = openapi_client.models.branding.Branding(
    ...
    def testClientConfigBrandings(self):
        """Test ClientConfigBrandings"""
