...
class TestCollectionMutableProperties(unittest.TestCase):
    """CollectionMutableProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionMutableProperties:
        """Test CollectionMutableProperties
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionMutableProperties`
        """
        model = CollectionMutableProperties()
        if include_optional:
            return CollectionMutableProperties(
                name = '',
                description = '',
                added_roles = [
    ...
    def testCollectionMutableProperties(self):
        """Test CollectionMutableProperties"""
