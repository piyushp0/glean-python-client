...
class TestCountInfo(unittest.TestCase):
    """CountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountInfo:
        """Test CountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountInfo`
        """
        model = CountInfo()
        if include_optional:
            return CountInfo(
