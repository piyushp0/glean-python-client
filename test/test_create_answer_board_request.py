...
class TestCreateAnswerBoardRequest(unittest.TestCase):
    """CreateAnswerBoardRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnswerBoardRequest:
        """Test CreateAnswerBoardRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnswerBoardRequest`
        """
        model = CreateAnswerBoardRequest()
        if include_optional:
            return CreateAnswerBoardRequest(
                name = '',
                description = '',
                added_roles = [
    ...
    def testCreateAnswerBoardRequest(self):
        """Test CreateAnswerBoardRequest"""
