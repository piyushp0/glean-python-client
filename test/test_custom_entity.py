...
class TestCustomEntity(unittest.TestCase):
    """CustomEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEntity:
        """Test CustomEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEntity`
        """
        model = CustomEntity()
        if include_optional:
            return CustomEntity(
                ...
                datasource = '',
                object_type = '',
                metadata = openapi_client.models.custom_entity_metadata.CustomEntityMetadata(
                    custom_data = {
