...
class TestDocumentOrError(unittest.TestCase):
    """DocumentOrError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentOrError:
        ...
        if include_optional:
            return DocumentOrError(
                ...
                parent_document = openapi_client.models.document.Document(
                    id = '', 
                    datasource = '', 
                    connector_type = 'API_CRAWL', 
                    doc_type = '', 
