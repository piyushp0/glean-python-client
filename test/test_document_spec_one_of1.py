...
class TestDocumentSpecOneOf1(unittest.TestCase):
    """DocumentSpecOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentSpecOneOf1:
        ...
        """
        model = DocumentSpecOneOf1()
        if include_optional:
            return DocumentSpecOneOf1(
                id = ''
            )
        else:
            return DocumentSpecOneOf1(
    ...
    def testDocumentSpecOneOf1(self):
        """Test DocumentSpecOneOf1"""
