...
class TestDownloadInsightsRequest(unittest.TestCase):
    """DownloadInsightsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadInsightsRequest:
        """Test DownloadInsightsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownloadInsightsRequest`
        """
        model = DownloadInsightsRequest()
        if include_optional:
            return DownloadInsightsRequest(
                categories = [
                    'AI'
                    ],
                departments = [
    ...
    def testDownloadInsightsRequest(self):
        """Test DownloadInsightsRequest"""
