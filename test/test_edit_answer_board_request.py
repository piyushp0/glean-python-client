...
class TestEditAnswerBoardRequest(unittest.TestCase):
    """EditAnswerBoardRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditAnswerBoardRequest:
        """Test EditAnswerBoardRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditAnswerBoardRequest`
        """
        model = EditAnswerBoardRequest()
        if include_optional:
    ...
    def testEditAnswerBoardRequest(self):
        """Test EditAnswerBoardRequest"""
