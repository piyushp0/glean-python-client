...
class TestEditCollectionRequest(unittest.TestCase):
    """EditCollectionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditCollectionRequest:
        """Test EditCollectionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditCollectionRequest`
        """
    ...
    def testEditCollectionRequest(self):
        """Test EditCollectionRequest"""
