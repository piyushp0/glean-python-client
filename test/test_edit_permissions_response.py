...
class TestEditPermissionsResponse(unittest.TestCase):
    """EditPermissionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditPermissionsResponse:
        """Test EditPermissionsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditPermissionsResponse`
        """
        model = EditPermissionsResponse()
        if include_optional:
    ...
    def testEditPermissionsResponse(self):
        """Test EditPermissionsResponse"""
