...
class TestExtractedQnA(unittest.TestCase):
    """ExtractedQnA unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtractedQnA:
        """Test ExtractedQnA
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtractedQnA`
        """
        model = ExtractedQnA()
        if include_optional:
            return ExtractedQnA(
