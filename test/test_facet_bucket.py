...
class TestFacetBucket(unittest.TestCase):
    """FacetBucket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacetBucket:
        """Test FacetBucket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacetBucket`
        """
        model = FacetBucket()
        if include_optional:
            return FacetBucket(
