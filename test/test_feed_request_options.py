...
class TestFeedRequestOptions(unittest.TestCase):
    """FeedRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedRequestOptions:
        ...
        """
        model = FeedRequestOptions()
        if include_optional:
            return FeedRequestOptions(
                result_size = 56,
                timezone_offset = 56,
                category_to_result_size = {
                    'key' : openapi_client.models.feed_request_options_category_to_result_size_value.FeedRequestOptions_categoryToResultSize_value(
                        result_size = 56, )
                    },
                datasource_filter = [
                    ''
    ...
    def testFeedRequestOptions(self):
        """Test FeedRequestOptions"""
