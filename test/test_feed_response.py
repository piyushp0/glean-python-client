...
class TestFeedResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FeedResponse:
        """Test FeedResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedResponse`
        """
        model = FeedResponse()
        if include_optional:
            return FeedResponse(
                ...
                server_timestamp = 56,
                results = [
                    openapi_client.models.feed_result.FeedResult(
                        category = 'DOCUMENT_SUGGESTION', 
                        primary_entry = openapi_client.models.feed_entry.FeedEntry(
                            entry_id = '', 
                            title = '', 
                ...
                backend_time_millis = 56,
                datasource_affinity = {
                    'key' : 1.337
                    },
                company_resources_collection_id = 56,
                facet_results = {
                    'key' : [
                        openapi_client.models.facet_result.FacetResult(
                            source_name = 'container_name', 
                ...
                mentions_time_window_in_hours = 56
            )
        else:
            return FeedResponse(
                server_timestamp = 56,
