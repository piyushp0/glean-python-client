...
class TestGeneratedAttachment(unittest.TestCase):
    """GeneratedAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratedAttachment:
        """Test GeneratedAttachment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratedAttachment`
        """
        model = GeneratedAttachment()
        if include_optional:
            return GeneratedAttachment(
                ...
                customer = openapi_client.models.customer.Customer(
                    ...
                    metadata = openapi_client.models.customer_metadata.CustomerMetadata(
                        datasource_id = '', 
                        custom_data = {
    ...
    def testGeneratedAttachment(self):
        """Test GeneratedAttachment"""
