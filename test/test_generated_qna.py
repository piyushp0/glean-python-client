...
class TestGeneratedQna(unittest.TestCase):
    """GeneratedQna unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratedQna:
        """Test GeneratedQna
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratedQna`
        """
        model = GeneratedQna()
        if include_optional:
            return GeneratedQna(
