...
class TestGetDocumentsByFacetsResponse(unittest.TestCase):
    """GetDocumentsByFacetsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDocumentsByFacetsResponse:
        """Test GetDocumentsByFacetsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDocumentsByFacetsResponse`
        """
        model = GetDocumentsByFacetsResponse()
        if include_optional:
            return GetDocumentsByFacetsResponse(
                documents = [
    ...
    def testGetDocumentsByFacetsResponse(self):
        """Test GetDocumentsByFacetsResponse"""
