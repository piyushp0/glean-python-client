...
class TestGleanAssistInsightsResponse(unittest.TestCase):
    """GleanAssistInsightsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GleanAssistInsightsResponse:
        """Test GleanAssistInsightsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GleanAssistInsightsResponse`
        """
        model = GleanAssistInsightsResponse()
        if include_optional:
            return GleanAssistInsightsResponse(
    ...
    def testGleanAssistInsightsResponse(self):
        """Test GleanAssistInsightsResponse"""
