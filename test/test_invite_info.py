...
class TestInviteInfo(unittest.TestCase):
    """InviteInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteInfo:
        """Test InviteInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteInfo`
        """
        model = InviteInfo()
        if include_optional:
            return InviteInfo(
