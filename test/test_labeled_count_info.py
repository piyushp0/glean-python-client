...
class TestLabeledCountInfo(unittest.TestCase):
    """LabeledCountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabeledCountInfo:
        """Test LabeledCountInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabeledCountInfo`
        """
        model = LabeledCountInfo()
        if include_optional:
            return LabeledCountInfo(
                label = '',
                count_info = [
