...
class TestListShortcutsPaginatedResponse(unittest.TestCase):
    """ListShortcutsPaginatedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListShortcutsPaginatedResponse:
        """Test ListShortcutsPaginatedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListShortcutsPaginatedResponse`
        """
        model = ListShortcutsPaginatedResponse()
        if include_optional:
            return ListShortcutsPaginatedResponse(
                ...
                meta = openapi_client.models.shortcuts_pagination_metadata.ShortcutsPaginationMetadata(
                    cursor = '', 
                    has_next_page = True, 
                    total_item_count = 56, )
            )
    ...
    def testListShortcutsPaginatedResponse(self):
        """Test ListShortcutsPaginatedResponse"""
