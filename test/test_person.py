    ...
    def make_instance(self, include_optional) -> Person:
        ...
        if include_optional:
            return Person(
                ...
                metadata = {"department":"Movies","email":"george@example.com","location":"Hollywood, CA","phone":6505551234,"photoUrl":"https://example.com/george.jpg","startDate":"2000-01-23","title":"Actor"}
            )
        else:
            return Person(
                name = '',
