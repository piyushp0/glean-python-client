...
class TestPreviewUgcRequest(unittest.TestCase):
    """PreviewUgcRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewUgcRequest:
        """Test PreviewUgcRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewUgcRequest`
        """
        model = PreviewUgcRequest()
        if include_optional:
            return PreviewUgcRequest(
                draft = openapi_client.models.ugc_draft.UgcDraft(
                    announcement = openapi_client.models.announcement_mutable_properties.AnnouncementMutableProperties(
                        ...
                        thumbnail = openapi_client.models.thumbnail.Thumbnail(
                            photo_id = '', 
                            url = '', ), 
                        banner = openapi_client.models.thumbnail.Thumbnail(
                            photo_id = '', 
                            url = '', ), 
                        audience_filters = [
                        ...
                        is_prioritized = True, 
                        view_url = '', ), 
                    answer = openapi_client.models.answer_mutable_properties.AnswerMutableProperties(
    ...
    def testPreviewUgcRequest(self):
        """Test PreviewUgcRequest"""
