...
class TestProductTerms(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProductTerms:
        """Test ProductTerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductTerms`
        """
        model = ProductTerms()
        if include_optional:
            return ProductTerms(
