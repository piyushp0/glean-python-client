...
class TestPromptTemplateResult(unittest.TestCase):
    """PromptTemplateResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromptTemplateResult:
        """Test PromptTemplateResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromptTemplateResult`
        """
    ...
    def testPromptTemplateResult(self):
        """Test PromptTemplateResult"""
