...
class TestQuerySuggestion(unittest.TestCase):
    """QuerySuggestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuerySuggestion:
        """Test QuerySuggestion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuerySuggestion`
        """
        ...
        if include_optional:
            return QuerySuggestion(
                ...
                label = '',
                datasource = '',
                request_options = {"datasourceFilter":"JIRA","datasourcesFilter":["JIRA"],"queryOverridesFacetFilters":true,"facetFilters":[{"fieldName":"fieldName","values":["fieldValues","fieldValues"]},{"fieldName":"fieldName","values":["fieldValues","fieldValues"]}]},
                ranges = [
