...
class TestRelatedQuestion(unittest.TestCase):
    """RelatedQuestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedQuestion:
        """Test RelatedQuestion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedQuestion`
        """
