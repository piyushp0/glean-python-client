...
class TestResultsRequest(unittest.TestCase):
    """ResultsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultsRequest:
        """Test ResultsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultsRequest`
        """
        model = ResultsRequest()
        if include_optional:
