...
class TestResultsResponse(unittest.TestCase):
    """ResultsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultsResponse:
        """Test ResultsResponse
