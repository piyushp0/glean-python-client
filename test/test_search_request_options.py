...
class TestSearchRequestOptions(unittest.TestCase):
    """SearchRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRequestOptions:
        ...
        if include_optional:
            return SearchRequestOptions(
                ...
                facet_bucket_filter = openapi_client.models.facet_bucket_filter.FacetBucketFilter(
                    facet = '', 
                    prefix = '', ),
                facet_bucket_size = 56,
                default_facets = [
                    ''
                    ],
                auth_tokens = [
    ...
    def testSearchRequestOptions(self):
        """Test SearchRequestOptions"""
