    ...
    def make_instance(self, include_optional) -> SearchResponse:
        ...
        if include_optional:
            return SearchResponse(
                ...
                metadata = openapi_client.models.search_response_metadata.SearchResponseMetadata(
                    rewritten_query = '', 
                    searched_query = '', 
                ...
                result_tabs = [
                    openapi_client.models.result_tab.ResultTab(
                        id = '', 
                        count = 56, 
                        datasource = '', 
                        datasource_instance = '', )
                ...
                results_description = openapi_client.models.results_description.ResultsDescription(
                    text = '', 
                    icon_config = {"color":"#343CED","key":"person_icon","iconType":"GLYPH","name":"user"}, ),
