...
class TestShortcutMetadata(unittest.TestCase):
    """ShortcutMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShortcutMetadata:
        """Test ShortcutMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShortcutMetadata`
        """
        model = ShortcutMetadata()
        if include_optional:
            return ShortcutMetadata(
                ...
                destination_document = openapi_client.models.document.Document(
                    id = '', 
                    datasource = '', 
