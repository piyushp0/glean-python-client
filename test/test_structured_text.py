...
class TestStructuredText(unittest.TestCase):
    """StructuredText unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StructuredText:
        """Test StructuredText
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StructuredText`
        """
        ...
        if include_optional:
            return StructuredText(
                ...
                structured_list = [
                    openapi_client.models.structured_text_item.StructuredTextItem(
