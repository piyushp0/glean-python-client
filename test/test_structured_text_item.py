...
class TestStructuredTextItem(unittest.TestCase):
    """StructuredTextItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StructuredTextItem:
        """Test StructuredTextItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StructuredTextItem`
        """
        model = StructuredTextItem()
        if include_optional:
    ...
    def testStructuredTextItem(self):
        """Test StructuredTextItem"""
