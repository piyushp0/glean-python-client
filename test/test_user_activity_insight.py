...
class TestUserActivityInsight(unittest.TestCase):
    """UserActivityInsight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserActivityInsight:
        """Test UserActivityInsight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserActivityInsight`
        """
        model = UserActivityInsight()
        if include_optional:
            return UserActivityInsight(
    ...
    def testUserActivityInsight(self):
        """Test UserActivityInsight"""
