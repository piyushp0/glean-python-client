...
class TestVerificationMetadata(unittest.TestCase):
    """VerificationMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerificationMetadata:
        """Test VerificationMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerificationMetadata`
        """
    ...
    def testVerificationMetadata(self):
        """Test VerificationMetadata"""
